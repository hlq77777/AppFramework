...
import com.android.kingwong.appframework.novate.cache.CookieCacheImpl;
import com.android.kingwong.appframework.novate.callback.ResponseCallback;
import com.android.kingwong.appframework.novate.config.ConfigLoader;
import com.android.kingwong.appframework.novate.cookie.AddCookiesInterceptor;
import com.android.kingwong.appframework.novate.cookie.NovateCookieManager;
import com.android.kingwong.appframework.novate.cookie.ReceivedCookiesInterceptor;
import com.android.kingwong.appframework.novate.cookie.SharedPrefsCookiePersistor;
import com.android.kingwong.appframework.novate.download.DownLoadCallBack;
import com.android.kingwong.appframework.novate.download.DownSubscriber;
...
import com.android.kingwong.appframework.novate.request.NovateRequestBody;
import com.android.kingwong.appframework.novate.request.RequestInterceptor;
...
import com.android.kingwong.appframework.novate.util.Utils;
...
public final class Novate {
    ...
    public <T> T call(Observable<T> observable, ResponseCallback callback) {
        return (T) observable.compose(schedulersTransformer)
                .compose(handleErrTransformer())
                .subscribeWith(new RxSubscriber<T, ResponseBody>(observable.getClass().getSimpleName(), callback));
    }
...
*/
    ...
    public <T> T executeGet(final String url, final Map<String, Object> maps, final ResponseCallBack<T> callBack) {
        return (T) apiManager.executeGet(url, maps)
                .compose(schedulersTransformer)
                .compose(handleErrTransformer())
                .subscribeWith(new NovateSubscriber<T>(mContext, callBack));
    }
    ...
    public <T> T rxGet(final String tag, final String url, @NonNull final Map<String, Object> maps, final ResponseCallback<T, ResponseBody> callBack) {
        ...
        return (T) apiManager.executeGet(url, maps)
                ...
                .compose(schedulersTransformer)
                .compose(handleErrTransformer())
                .subscribeWith(new RxSubscriber<T, ResponseBody>(tag, callBack).addContext(mContext));
    }
    ...
    public <T> T rxDownload(Object tag, String url, final ResponseCallback callBack) {
       /* okhttpBuilder.networkInterceptors().add(new Interceptor() {
        ...
        return (T) downObservable.compose(schedulersTransformerDown)
                .compose(handleErrTransformer())
                .subscribeWith(new RxSubscriber<T, ResponseBody>(tag, callBack));
    ...
    private class HandleFuc<T> implements Function<NovateResponse<T>, T> {
        @Override
        public T apply(NovateResponse<T> response) {
...
*/
     ...
     * @param subscriber
     */
    public <T> T form(String url, @FieldMap(encoded = true) Map<String, Object> fields, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @param subscriber
     */
    public void body(String url, Object body, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @param subscriber
     */
    public <T> T json(String url, String jsonStr, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @return
     */
    public <T> T test(String url, Map<String, T> maps, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @return
     */
    public <T> T upload(String url, RequestBody requestBody, DisposableObserver<ResponseBody> subscriber) {
        return (T) apiManager.postRequestBody(url, requestBody)
                .compose(schedulersTransformer)
                .compose(handleErrTransformer())
                .subscribeWith(subscriber);
     ...
     * @return
     */
    public <T> T uploadImage(String url, File file, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @return
     */
    public <T> T uploadFlie(String url, RequestBody file, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @return
     */
    public <T> T uploadFlie(String url, RequestBody description, MultipartBody.Part file, DisposableObserver<ResponseBody> subscriber) {
     ...
     * @return
     */
    public <T> T uploadFlies(String url, Map<String, RequestBody> files, DisposableObserver<ResponseBody> subscriber) {
    ...
    public <T> T uploadFileWithPartMap(String url, Map<String, RequestBody> partMap,
                                       @Part("file") MultipartBody.Part file, DisposableObserver<ResponseBody> subscriber) {
    ...
    private <T> T executeDownload(String key, String url, String savePath, String name, final DownLoadCallBack callBack) {
      ...
      /*  okhttpBuilder.networkInterceptors().add(new Interceptor() {
        ...
        return (T) downObservable.compose(schedulersTransformerDown)
                .compose(handleErrTransformer())
                .subscribeWith(new DownSubscriber<ResponseBody>(key, savePath, name, callBack, mContext));
