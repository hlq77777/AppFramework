...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        a = context.obtainStyledAttributes(attrs, R.styleable.PagerSlidingTabStrip, 0, 0);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            }else if(pager.getAdapter() instanceof IconAndTextTabProvider){
                addIconAndTextTab(i, pager.getAdapter().getPageTitle(i).toString(),((IconAndTextTabProvider) pager.getAdapter()).getPageIconResId(i));
            }else{
    ...
    private void addIconAndTextTab(final int position,String title, int resId) {
        ...
        LinearLayout.LayoutParams imageparam = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ImageView imageButton = new ImageView(getContext());
        imageButton.setId(R.id.tabs);
        imageButton.setBackground(getResources().getDrawable(resId));
        imageparam.gravity = Gravity.CENTER_HORIZONTAL;
        imageButton.setLayoutParams(imageparam);
