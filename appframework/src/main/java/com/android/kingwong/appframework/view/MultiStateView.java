...
public class MultiStateView extends FrameLayout {
    ...
    private static final int LAYOUT_ERROR_ID = R.layout.layout_error;
    private static final int LAYOUT_LOADING_ID = R.layout.layout_loading;
    private static final int LAYOUT_NODATA_ID = R.layout.layout_empty;

    private boolean isMatchHeight = false;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (loadingViewResId <= -1) {
            loadingViewResId = LAYOUT_LOADING_ID;
        }
        ...
        isMatchHeight = a.getBoolean(R.styleable.MultiStateView_msv_match_height, false);
        a.recycle();
    ...
    public void fillScreen(Activity activity) {
