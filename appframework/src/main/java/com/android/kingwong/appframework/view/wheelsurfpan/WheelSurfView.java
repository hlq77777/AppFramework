...
public class WheelSurfView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if ( mGoImgRes == 0 ) {
            mStart.setImageResource(R.drawable.luckypan_pointer);
        } else {
    ...
    public void setConfig(Builder builder) {
        ...
        if (builder.mMainImgBitmap != null)
            mWheelSurfPanView.setmMainImgBitmap(builder.mMainImgBitmap);
     ...
     *
     */
    public void setStartClickable(boolean f){
        mStart.setClickable(f);
    }
    ...
    public static final class Builder {
        ...
        public final WheelSurfView.Builder setmMainImgBitmap(Bitmap mMainImgBitmap) {
            this.mMainImgBitmap = mMainImgBitmap;
            return this;
        }
